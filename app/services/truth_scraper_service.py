...
class TruthScraperService:
    def __init__(self, truth_service: TruthService, target_username="realDonaldTrump", headless=True, scroll_iterations=4):
    ...
    class TruthResponseHandler:
        ...
        async def handle_response(self, response):
            ...
            truths_data = await self.parent.extract_key_properties(data)
    ...
    async def _run_browser_session(self, playwright, start_url):
        ...
        try:
            ...
            await asyncio.sleep(5)  # Additional wait to ensure all posts are loaded
            ...
            for i in range(1, self.scroll_iterations + 1):
                ...
                await asyncio.sleep(2)  # Wait for posts to load
